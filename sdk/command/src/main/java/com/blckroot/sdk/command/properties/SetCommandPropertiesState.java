...
public enum SetCommandPropertiesState {
    ...
    SET_COMMAND_PROPERTIES_FROM_FILE {
        ...
        @Override
        public Integer run(Command command) {
            String applicationBaseDirectory = System.getProperty("blckroot." + command.getName() + ".base.dir");
            FileSystemService fileSystemService = new FileSystemService();
            String applicationPropertiesFilePath = applicationBaseDirectory +
                    FileSystems.getDefault().getSeparator() + "etc" + FileSystems.getDefault().getSeparator() +
                    command.getName() + ".properties";

            Properties properties = fileSystemService.getPropertiesFromFile(applicationPropertiesFilePath);
